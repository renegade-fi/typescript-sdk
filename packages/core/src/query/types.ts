...
import type { Evaluate, StrictOmit } from "../types/utils.js";
...
export type InfiniteQueryOptions<
    ...
    options extends InfiniteQueryObserverOptions<
        ...
        queryKey,
        pageParam
    > = InfiniteQueryObserverOptions<queryFnData, error, data, queryData, queryKey, pageParam>,
> = Evaluate<
...
type QueryFunctionContext<TQueryKey extends QueryKey = QueryKey, TPageParam = never> = Parameters<
    QueryFunction<unknown, TQueryKey, TPageParam>
>[0];
...
> = undefined extends variables
    ? (
          variables?: variables,
          options?: Evaluate<MutateOptions<data, error, variables, context>> | undefined,
      ) => Promise<data>
    : (
          variables: variables,
          options?: Evaluate<MutateOptions<data, error, variables, context>> | undefined,
