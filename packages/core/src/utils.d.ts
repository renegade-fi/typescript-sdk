 ...
 * @returns {Promise<any>}
 */
export function new_order_in_matching_pool(
    seed: string | undefined,
    wallet_str: string,
    id: string,
    base_mint: string,
 ...
 * @returns {any}
 */
export function new_external_order(
    base_mint: string,
    quote_mint: string,
    side: string,
    base_amount: string,
 ...
 * @returns {any}
 */
export function new_external_quote_request(
    base_mint: string,
    quote_mint: string,
    side: string,
    base_amount: string,
 ...
 * @returns {any}
 */
export function assemble_external_match(
    do_gas_estimation: boolean,
    updated_order: string,
    sponsored_quote_response: string,
    receiver_address: string,
): any;
/**
 ...
 * @returns {Promise<any>}
 */
export function find_external_wallet(
    wallet_id: string,
    blinder_seed: string,
    share_seed: string,
    pk_root: string,
 ...
 * @returns {Promise<any>}
 */
export function create_external_wallet(
    wallet_id: string,
    blinder_seed: string,
    share_seed: string,
    pk_root: string,
 ...
 * @returns {string}
 */
export function create_request_signature(
    path: string,
    headers: any,
    body: string,
    key: string,
