...
export const GET_WALLET_ROUTE = (wallet_id) => `/wallet/${wallet_id}`;
...
export const BACK_OF_QUEUE_WALLET_ROUTE = (wallet_id) => `/wallet/${wallet_id}/back-of-queue`;
// Route to the orders of a given wallet
export const WALLET_ORDERS_ROUTE = (wallet_id) => `/wallet/${wallet_id}/orders`;
// Returns a single order by the given identifier
export const GET_ORDER_BY_ID_ROUTE = (wallet_id, order_id) => `/wallet/${wallet_id}/orders/${order_id}`;
// Updates a given order
export const UPDATE_ORDER_ROUTE = (wallet_id, order_id) => `/wallet/${wallet_id}/orders/${order_id}/update`;
// Cancels a given order
export const CANCEL_ORDER_ROUTE = (wallet_id, order_id) => `/wallet/${wallet_id}/orders/${order_id}/cancel`;
// Returns the balances within a given wallet
export const GET_BALANCES_ROUTE = (wallet_id) => `/wallet/${wallet_id}/balances`;
// Returns the balance associated with the given mint
export const GET_BALANCE_BY_MINT_ROUTE = (wallet_id, mint) => `/wallet/${wallet_id}/balances/${mint}`;
// Deposits an ERC-20 token into the darkpool
export const DEPOSIT_BALANCE_ROUTE = (wallet_id) => `/wallet/${wallet_id}/balances/deposit`;
// Withdraws an ERC-20 token from the darkpool
export const WITHDRAW_BALANCE_ROUTE = (wallet_id, mint) => `/wallet/${wallet_id}/balances/${mint}/withdraw`;
// Pays all wallet fees
export const PAY_FEES_ROUTE = (wallet_id) => `/wallet/${wallet_id}/pay-fees`;
// Returns the order history of a wallet
export const ORDER_HISTORY_ROUTE = (wallet_id) => `/wallet/${wallet_id}/order-history`;
////////////////////////////////////////////////////////////////////////////////
// Network
////////////////////////////////////////////////////////////////////////////////
...
export const GET_CLUSTER_INFO_ROUTE = (cluster_id) => `/network/clusters/${cluster_id}`;
// Returns the peer info for a given peer
export const GET_PEER_INFO_ROUTE = (peer_id) => `/network/peers/${peer_id}`;
////////////////////////////////////////////////////////////////////////////////
// Order Book
////////////////////////////////////////////////////////////////////////////////
...
export const GET_NETWORK_ORDER_BY_ID_ROUTE = (order_id) => `/order_book/orders/${order_id}`;
////////////////////////////////////////////////////////////////////////////////
// Price Report
////////////////////////////////////////////////////////////////////////////////
// Price report route
...
export const GET_TASK_STATUS_ROUTE = (task_id) => `/tasks/${task_id}`;
// Get the task queue of a given wallet
export const GET_TASK_QUEUE_ROUTE = (wallet_id) => `/task_queue/${wallet_id}`;
/// The route to fetch task history for a wallet
export const TASK_HISTORY_ROUTE = (wallet_id) => `/wallet/${wallet_id}/task-history`;
////////////////////////////////////////////////////////////////////////////////
// Websockets
////////////////////////////////////////////////////////////////////////////////
...
export const WALLET_ROUTE = (wallet_id) => `/v0/wallet/${wallet_id}`;
// Fetches price reports based on source, base, and quote currencies
export const WS_PRICE_REPORT_ROUTE = (source, base, quote) => `/v0/price_report/${source}/${base}/${quote}`;
...
export const TASK_STATUS_ROUTE = (task_id) => `/v0/tasks/${task_id}`;
/// The task history topic, streams information about historical tasks
export const WS_TASK_HISTORY_ROUTE = (wallet_id) => `/v0/wallet/${wallet_id}/task-history`;
/// The wallet order status topic, streams events about wallet's orders
export const WS_WALLET_ORDERS_ROUTE = (wallet_id) => `/v0/wallet/${wallet_id}/order-status`;
////////////////////////////////////////////////////////////////////////////////
// Price Reporter
////////////////////////////////////////////////////////////////////////////////
export const PRICE_REPORTER_TOPIC = (exchange, base, quote) => `${exchange}-${base.toLowerCase()}-${quote.toLowerCase()}`;
////////////////////////////////////////////////////////////////////////////////
// Token
////////////////////////////////////////////////////////////////////////////////
