 ...
 * @param {Uint8Array} extended_sig_bytes
 * @returns {string}
 */
function derive_schnorr_public_key(extended_sig_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(extended_sig_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.derive_schnorr_public_key(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
exports.derive_schnorr_public_key = derive_schnorr_public_key;
